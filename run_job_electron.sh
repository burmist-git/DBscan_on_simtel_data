...
#SBATCH --error /srv/beegfs/scratch/users/b/burmistr/sim_telarray/prod5/NSB_268MHz/electron/dbscan_npe/job_error/crgen_%j.error
#SBATCH --output /srv/beegfs/scratch/users/b/burmistr/sim_telarray/prod5/NSB_268MHz/electron/dbscan_npe/job_output/output_%j.output
#SBATCH --mem=40G
#SBATCH --ntasks 1
